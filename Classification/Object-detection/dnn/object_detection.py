# USAGE
# python object_detection.py  --prototxt MobileNetSSD_deploy.prototxt.txt --model MobileNetSSD_deploy.caffemodel --dir folder
...
def process_image(file):
	...
	if outText != "":
		...
		print >> outFile, "%s\t%s" % (filename,outText) # separator data = tab
		outFile.close()
	else:
		print "\tno detection"
