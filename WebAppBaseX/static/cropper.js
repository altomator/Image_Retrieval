var Cropper = function () {
    ...
    var e = {
        container_class: "cropper", width: 0, height: 0, min_width: 0, min_height: 0, max_width: 0, max_height: 0, ratio: {
            width: 0, height: 0
        }
    };
    ...
    (), s = function (t, n) {
        ...
        this.moving = this.resizing = this.direction = ! 1, this.handles = {
        },
        this.overlays = {
        },
        this.wrapImage(), this.attachEventListeners()
    };
    return s.prototype.wrapImage = function () {
        var e = document.createElement("div");
        e.className = this.options.container_class;
        var n = this.image.parentNode, r = this.image.nextSibling;
    ...
    s.prototype.createHandles = function (e) {
        var t = this, i = "-3px", s = {
            ...
            n: {
                left: "50%", top: i, marginLeft: i
            },
            ne: {
                right: i, top: i
            },
            e: {
                right: i, top: "50%", marginTop: i
            },
            se: {
                right: i, bottom: i, zIndex: 10
            },
            s: {
                left: "50%", bottom: i, marginLeft: i
            },
            sw: {
                left: i, bottom: i
            },
            w: {
                left: i, top: "50%", marginTop: i
            }
        };
        for (var o in s) {
            var u = s[o], a = document.createElement("div");
    ...
    s.prototype.createOverlays = function () {
        var e = {
            ...
            bottom: {
                left: 0, bottom: 0, right: 0, width: "100%"
            }
        };
        for (position in e) {
            var t = e[position], n = document.createElement("div");
    ...
    s.prototype.mouseDown = function (e) {
        r(e).stop();
        var t = r(e).target, n = this.getCursorPosition(e);
        ...
        var s = this.options.width ? this.options.width: this.options.min_width ? this.options.min_width: 0, o = this.options.height ? this.options.height: this.options.min_height ? this.options.min_height: 0;
    ...
    s.prototype.resize = function (e) {
        ...
        var t = this.getCursorPosition(e), n = this.dragStartCrop.x, r = this.dragStartCrop.y, i = this.dragStartCrop.width, s = this.dragStartCrop.height;
    ...
    s.prototype.move = function (e) {
        var t = this.getCursorPosition(e), n = t.x - this.dragStart.x, r = t.y - this.dragStart.y;
    ...
    s.prototype.getCursorPosition = function (e) {
        ...
        return e = r(e), {
            x: Math.round(e.clientX - t.left), y: Math.round(e.clientY - t.top)
        }
    },
    s
}
